...
If you still use exception suppression mode, by default, in case of an exception, the `cancelled` attribute will contain `False`. If you want to change this, pass it there as the `default` parameter - `True`.
